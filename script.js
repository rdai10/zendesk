...
function (_preact$Component) {
  ...
  _createClass(ArticlesList, [{
    ...
    value: function getArticles() {
      ...
      Object(_helpers_api_helpers__WEBPACK_IMPORTED_MODULE_3__["getArticlesBySectionId"])(id, locale, NUMBER_OF_ARTICLES).then(function (_ref) {
        var data = _ref.data;
...
function (_preact$Component2) {
  ...
  _createClass(DocSideNav, [{
    ...
    value: function componentDidMount() {
      ...
      Object(_helpers_api_helpers__WEBPACK_IMPORTED_MODULE_3__["getSectionBySectionId"])(sectionId, locale).then(function (_ref4) {
        var data = _ref4.data;
    ...
    value: function render(_ref6, _ref7) {
      ...
      var currentArticleId = _ref6.currentArticleId,
          locale = _ref6.locale;
      var expandedItemId = _ref7.expandedItemId,
          items = _ref7.items;
  ...
  _createClass(SearchResultBreadCrumb, [{
    ...
    value: function componentDidMount() {
      ...
      var _this$props = this.props,
          id = _this$props.id,
          locale = _this$props.locale;
      Object(_helpers_api_helpers__WEBPACK_IMPORTED_MODULE_2__["getSectionBySectionId"])(id, locale, 'categories').then(function (_ref) {
        var data = _ref.data;
...
function (_preact$Component2) {
  ...
  _createClass(SearchResults, [{
    ...
    value: function handlePaginationClick(currentPage) {
      ...
      Object(_helpers_api_helpers__WEBPACK_IMPORTED_MODULE_2__["getArticlesBySearch"])(queryString, ARTICLES_PER_PAGE, currentPage, productLabel, locale).then(function (_ref2) {
        var data = _ref2.data;
    ...
    value: function querySearchResults(label) {
      ...
      if (queryString) {
        Object(_helpers_api_helpers__WEBPACK_IMPORTED_MODULE_2__["getArticlesBySearch"])(queryString, ARTICLES_PER_PAGE, 1, label, locale).then(function (_ref3) {
          var data = _ref3.data;
    ...
    value: function render(_ref4, _ref5) {
      var fastTrackLabel = _ref4.fastTrackLabel,
          filterLabel = _ref4.filterLabel,
...
var baseURL =  false ? undefined : 'https://liferaysupport1528999723.zendesk.com/api/v2/';
...
function getArticlesBySearch(queryString) {
  ...
  return httpRequest.get("help_center/articles/search.json?query=".concat(queryString, "&label_names=").concat(label, "&per_page=").concat(count, "&page=").concat(page, "&locale=").concat(locale));
}
/**
...
function getArticlesBySectionId(id, locale, count) {
  ...
  return httpRequest.get("help_center/".concat(locale, "/sections/").concat(id, "/articles.json").concat(perPageCount));
}
/**
...
function getRequestById(id) {
  return httpRequest.get("requests/".concat(id));
}
/**
...
function getSectionBySectionId(id, locale) {
  ...
  return httpRequest.get("help_center/".concat(locale, "/sections/").concat(id, ".json?include=").concat(resourceNames));
}
/**
...
function getSectionsByCategoryId(id, locale) {
  return httpRequest.get("help_center/".concat(locale, "/categories/").concat(id, "/sections.json"));
}
/**
...
function displayArticleSuggestion(queryString, productLabel, locale, label, callback) {
  Object(_helpers_api_helpers__WEBPACK_IMPORTED_MODULE_0__["getArticlesBySearch"])(queryString, ARTICLES_PER_SUGGESTION, 1, productLabel, locale).then(function (_ref) {
    var data = _ref.data;
...
function hasWatcherPermission(userTags, id, callback) {
  Object(_api_helpers__WEBPACK_IMPORTED_MODULE_0__["getRequestById"])(id).then(function (_ref) {
    var data = _ref.data;
...
/*!*************************!*\
  !*** ./src/js/index.js ***!
  \*************************/
/*! exports provided: render, makeGETRequest, displayArticleSuggestion, addLocaleParamToURI, hasCreateTicketPermission, hasKBPermission, hasWatcherPermission, debounce, throttle, MegaMenu, Alert, CallToAction, DocSideNav, DocsTOC, ProductTabs, SearchResults */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "addLocaleParamToURI", function() { return _helpers_locale_conversion__WEBPACK_IMPORTED_MODULE_8__["addLocaleParamToURI"]; });

/* harmony import */ var _helpers_user_permissions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./helpers/user-permissions */ "./src/js/helpers/user-permissions.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "hasCreateTicketPermission", function() { return _helpers_user_permissions__WEBPACK_IMPORTED_MODULE_9__["hasCreateTicketPermission"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "hasKBPermission", function() { return _helpers_user_permissions__WEBPACK_IMPORTED_MODULE_9__["hasKBPermission"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "hasWatcherPermission", function() { return _helpers_user_permissions__WEBPACK_IMPORTED_MODULE_9__["hasWatcherPermission"]; });
...
/* harmony reexport (default from non-harmony) */ __webpack_require__.d(__webpack_exports__, "debounce", function() { return lodash_debounce__WEBPACK_IMPORTED_MODULE_10___default.a; });
...
/* harmony reexport (default from non-harmony) */ __webpack_require__.d(__webpack_exports__, "throttle", function() { return lodash_throttle__WEBPACK_IMPORTED_MODULE_11___default.a; });
/* harmony import */ var liferay_help_center_megamenu__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! liferay-help-center-megamenu */ "./node_modules/liferay-help-center-megamenu/dist/main.js");
/* harmony import */ var liferay_help_center_megamenu__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(liferay_help_center_megamenu__WEBPACK_IMPORTED_MODULE_12__);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MegaMenu", function() { return liferay_help_center_megamenu__WEBPACK_IMPORTED_MODULE_12__["MegaMenu"]; });

/* harmony import */ var _components_Alert__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/Alert */ "./src/js/components/Alert.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Alert", function() { return _components_Alert__WEBPACK_IMPORTED_MODULE_13__["default"]; });

/* harmony import */ var _components_CallToAction__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/CallToAction */ "./src/js/components/CallToAction.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CallToAction", function() { return _components_CallToAction__WEBPACK_IMPORTED_MODULE_14__["default"]; });

/* harmony import */ var _components_DocSideNav__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/DocSideNav */ "./src/js/components/DocSideNav.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DocSideNav", function() { return _components_DocSideNav__WEBPACK_IMPORTED_MODULE_15__["default"]; });

/* harmony import */ var _components_DocTOC__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/DocTOC */ "./src/js/components/DocTOC.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DocsTOC", function() { return _components_DocTOC__WEBPACK_IMPORTED_MODULE_16__["default"]; });

/* harmony import */ var _components_ProductTabs__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/ProductTabs */ "./src/js/components/ProductTabs.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ProductTabs", function() { return _components_ProductTabs__WEBPACK_IMPORTED_MODULE_17__["default"]; });

/* harmony import */ var _components_SearchResults__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/SearchResults */ "./src/js/components/SearchResults.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SearchResults", function() { return _components_SearchResults__WEBPACK_IMPORTED_MODULE_18__["default"]; });
