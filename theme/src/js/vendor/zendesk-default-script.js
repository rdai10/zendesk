...
$(document).ready(function() {
	...
	var commentContainerFormControls = $(
	...
	var showRequestCommentContainerTrigger = commentContainer.find(
	...
	var requestCommentSubmitButton = commentContainer.find(
		'input[type=submit]'
	);

	var requestMarkAsSolvedButton = requestContainer.find(
		'.mark-as-solved:not([data-disabled])'
	);

	requestMarkAsSolvedButton.on('click', function() {
		$('.request-container .comment-container input[type=checkbox]').attr(
			'checked',
			true
		);
	...
	requestCommentTextarea.on('keyup', function() {
		...
		if (hasText) {
			text = requestMarkAsSolvedButton.data(
				'solve-and-submit-translation'
			);
		}
